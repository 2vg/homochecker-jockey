...
use winapi::um::wininet::{
    InternetQueryOptionA, InternetSetOptionA, INTERNET_OPTION_PER_CONNECTION_OPTION,
    INTERNET_OPTION_SETTINGS_CHANGED, INTERNET_PER_CONN_FLAGS_UI, INTERNET_PER_CONN_OPTIONA,
    INTERNET_PER_CONN_OPTION_LISTA, INTERNET_PER_CONN_PROXY_SERVER, PROXY_TYPE_DIRECT,
    PROXY_TYPE_PROXY,
};
...
pub fn homo_proxy(server_addr: impl Into<String>, set: bool) -> Result<()> {
    unsafe {
        ...
        let mut options = [
            zeroed::<INTERNET_PER_CONN_OPTIONA>(),
            zeroed::<INTERNET_PER_CONN_OPTIONA>(),
        ];
